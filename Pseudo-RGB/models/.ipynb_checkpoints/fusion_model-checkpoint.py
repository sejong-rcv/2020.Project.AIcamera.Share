...
class FusionModel(BaseModel):
    ...
    def setup_to_test(self, fusion_weight_path):
        ...
        GF_state_dict = torch.load(GF_path, map_location='cuda:0')
        ...
        G_state_dict = torch.load(G_path, map_location='cuda:0')
        ...
        GComp_state_dict = torch.load(GComp_path, map_location='cuda:0')
